...
Function library for thedesi1 charts

Since a lot of the thedesi1 charts follow a similar pattern, this library was built to reduce maintenance cost between the charts that use it and try achieve a goal of being DRY.
...
- name: common
  version: 1.0.0
  repository: https://thedesi1.com/charts/
```

For more information, take a look at the [Docs](http://docs.thedesi1.com/our-helm-charts/common-library/).
...
**Important**: When deploying an application Helm chart you can add more values from our common library chart [here](https://github.com/thedesi1/library-charts/tree/main/charts/stable/common)
...
| addons.codeserver | object | See values.yaml | The common library supports adding a code-server add-on to access files. It can be configured under this key. For more info, check out [our docs](http://docs.thedesi1.com/our-helm-charts/common-library-add-ons/#code-server) |
...
| addons.vpn | object | See values.yaml | The common chart supports adding a VPN add-on. It can be configured under this key. For more info, check out [our docs](http://docs.thedesi1.com/our-helm-charts/common-library-add-ons/#wireguard-vpn) |
...
| addons.vpn.wireguard.image.repository | string | `"ghcr.io/thedesi1/wireguard"` | Specify the WireGuard image |
...
| persistence | object | See below | Configure persistence for the chart here. Additional items can be added by adding a dictionary key similar to the 'config' key. [[ref]](http://docs.thedesi1.com/our-helm-charts/common-library-storage) |
...
- See the [Docs](https://docs.thedesi1.com/our-helm-charts/getting-started/)
- Open an [issue](https://github.com/thedesi1/charts/issues/new/choose)
- Ask a [question](https://github.com/thedesi1/organization/discussions)
